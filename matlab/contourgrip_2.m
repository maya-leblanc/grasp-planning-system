...
cfg.stlFile       = 'mug.stl';
cfg.fruitName     = 'mug';           % used in CSV output
...
%% === SECTION 2–6: Multi-Height Slicing (single canonical version) =========
...
%% === SECTION 7–8: Grasp Feasibility Analysis ==============================
...
%% === SECTION 11: Partial Mesh / Simulated Occlusion =======================
